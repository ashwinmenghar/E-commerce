	...
	<div class="container panel-margin">
		...
		<div class="row text-center">
			<div class="col-md-3 col-sm-6">
				<div class="thumbnail">
					<img src="images/canon.jpg" alt="camera">
					<div class="caption">
						<h3>Canon Camera</h3>
			...
			<div class="col-md-3 col-sm-6">
				<div class="thumbnail">
					<img src="images/Olympus DSLR.jpg" alt="camera">
					<div class="caption">
						<h3> Olympus Camera</h3>
		...
		<div class="row text-center">
			...
			<div class="col-md-3 col-sm-6">
				<div class="thumbnail">
					<img src="images/tshirt 2.jpg" alt="shirt">
					<div class="caption">
						<h3>Shirt 2</h3>
			...
			<div class="col-md-3 col-sm-6">
				<div class="thumbnail">
					<img src="images/shirts 3.webp" alt="shirt">
					<div class="caption">
						<h3>Shirt 3</h3>
			...
			<div class="col-md-3 col-sm-6">
				<div class="thumbnail">
					<img src="images/shirts 4.jpg" alt="shirt">
					<div class="caption">
						<h3>Shirt 4</h3>
		...
		<div class="row text-center">
			<div class="col-md-3 col-sm-6">
				<div class="thumbnail">
					<img src="images/watches 3.webp" alt="watch">
					<div class="caption">
			...
			<div class="col-md-3 col-sm-6">
				<div class="thumbnail">
					<img src="images/watches 4.jpg" alt="watch">
					<div class="caption">
			...
			<div class="col-md-3 col-sm-6">
				<div class="thumbnail">
					<img src="images/watches-2.jpg" alt="watch">
					<div class="caption">
						<h3>HMT Milan</h3>
